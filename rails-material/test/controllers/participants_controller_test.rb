...
class ParticipantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create participant" do
    assert_difference('Participant.count') do
      post participants_url, params: { participant: { study_id: @participant.study_id, userkey: @participant.userkey } }
    end
  ...
  test "should update participant" do
    patch participant_url(@participant), params: { participant: { study_id: @participant.study_id, userkey: @participant.userkey } }
